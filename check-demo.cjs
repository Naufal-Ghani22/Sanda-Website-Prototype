...
(async()=>{
 ...
 await link('Perawatan').click();await button('Rencanakan repair').click();await page.locator('#modal').getByRole('radio',{name:/Penjahit contoh A/}).check();await button('Simpan pilihan repair').click();
